...
import cat from "../assets/pisica.png";
import animals_icon from "../assets/animals.png";
  ...
  useEffect(() => {
    const fetchAnimals = async () => {
      try {
        ...
        }>(`http://localhost:8090/api/animals/type/${animalType}?adopted=true`);
      ...
      <div className="container-fluid p-0 d-flex flex-column">
        <div className="mx-5 p-0 row d-flex justify-content-between">
          ...
          <div className="info_card animal_card d-flex col-md-3 flex-row align-items-center">
            ...
            <img src={animals_icon} alt="animal_icon" />
          </div>
        </div>
...
export default AdoptedAnimalsTable;
